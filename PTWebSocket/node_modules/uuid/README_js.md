...
uuidv3('https://example.com/hello', uuidv3.URL); // RESULT
...
// ... using predefined URL namespace (for, well, URLs)
uuidv5('https://example.com/hello', uuidv5.URL); // RESULT
...
```html
<script src="https://wzrd.in/standalone/uuid%2Fv3@latest"></script>
<script>
uuidv3('https://example.com/hello', uuidv3.URL); // -> v3 UUID
</script>
```
...
```html
<script src="https://wzrd.in/standalone/uuid%2Fv5@latest"></script>
<script>
uuidv5('https://example.com/hello', uuidv5.URL); // -> v5 UUID
</script>
```
