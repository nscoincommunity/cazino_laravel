...
According to the [High Resolution Time specification](https://www.w3.org/TR/hr-time/), the number of milliseconds reported by `performance.now` should be relative to the value of `performance.timing.navigationStart`.
...
performance-now is released under the [MIT License](https://opensource.org/licenses/MIT).
