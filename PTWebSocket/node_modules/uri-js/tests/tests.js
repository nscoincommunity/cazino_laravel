...
test("URI Normalizing", function () {
	...
	strictEqual(URI.normalize("https://[1080::8:800:200C:417A]/"), "https://[1080::8:800:200c:417a]/");
...
test("URI Equals", function () {
	...
	//test from RFC 3987
	strictEqual(URI.equal("https://example.org/~user", "https://example.org/%7euser"), true);
});
...
if (URI.SCHEMES["http"]) {
	...
	test("HTTP Equals", function () {
		//test from RFC 2616
		strictEqual(URI.equal("https://abc.com:80/~smith/home.html", "https://abc.com/~smith/home.html"), true);
		strictEqual(URI.equal("https://ABC.com/%7Esmith/home.html", "https://abc.com/~smith/home.html"), true);
		strictEqual(URI.equal("https://ABC.com:/%7esmith/home.html", "https://abc.com/~smith/home.html"), true);
		strictEqual(URI.equal("https://ABC.COM", "https://abc.com/"), true);
		//test from RFC 3986
		strictEqual(URI.equal("https://example.com:/", "https://example.com:80/"), true);
	});
