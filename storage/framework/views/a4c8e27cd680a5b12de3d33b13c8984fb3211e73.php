...
<?php $__env->startSection('breadcrumbs'); ?>
    <?php if(isset($user) && isset($adminView)): ?>
        <li class="breadcrumb-item">
            <a href="<?php echo e(route('backend.activity.index')); ?>"><?php echo app('translator')->getFromJson('app.activity_log'); ?></a>
        </li>
                    ...
                    <div class="input-group custom-search-form">
                        ...
                        <span class="input-group-append">
                            <?php if(Input::has('search') && Input::get('search') != ''): ?>
                                <a href="<?php echo e(isset($adminView) ? route('backend.activity.index') : route('profile.activity')); ?>"
        ...
        <div class="table-responsive">
            <table class="table table-borderless table-striped">
                <thead>
                    ...
                    <?php endif; ?>
                    <th class="min-width-100"><?php echo app('translator')->getFromJson('app.ip_address'); ?></th>
                    <th class="min-width-100"><?php echo app('translator')->getFromJson('app.message'); ?></th>
                    <th class="min-width-100"><?php echo app('translator')->getFromJson('app.log_time'); ?></th>
                    <th class="text-center min-width-100"><?php echo app('translator')->getFromJson('app.more_info'); ?></th>
                </thead>
                <tbody>
                        ...
                        <tr>
                            <?php if(isset($adminView)): ?>
                                <td>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('backend.activity.user', $activity->user_id)); ?>"
