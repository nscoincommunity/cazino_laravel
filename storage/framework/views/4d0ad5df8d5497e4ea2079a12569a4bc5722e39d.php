    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <?php if(settings('2fa.enabled')): ?>
                <?php echo Form::open(['route' => 'backend.settings.auth.2fa.disable', 'id' => 'auth-2fa-settings-form']); ?>
            ...
            <?php else: ?>
                <?php echo Form::open(['route' => 'backend.settings.auth.2fa.enable', 'id' => 'auth-2fa-settings-form']); ?>
