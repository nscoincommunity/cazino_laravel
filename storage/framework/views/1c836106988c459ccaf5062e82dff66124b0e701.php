...
<?php $__env->startSection('content'); ?>
  <div id="coinpayment-vue">
    <div class="text-center mt-3 mb-3">
      <img src="<?php echo e(asset(config('coinpayment.header_logo'))); ?>" width="180">
    </div>
    <hr>
    <div class="row justify-content-md-center">
      <div class="col-sm-3">
        ...
        <?php if(!empty(config('coinpayment.menus'))): ?>
          <div class="list-group mt-5">
            <?php $__currentLoopData = config('coinpayment.menus'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(url($menu['url'])); ?>" class="list-group-item list-group-item-action">
              <i class="<?php echo e($menu['class_icon']); ?>"></i> <?php echo e($key); ?>
  ...
  <script type="text/javascript">
    ...
    var vue = new Vue({
      ...
      methods:{
        getMethods(){
          var self = this;
          axios.get('<?php echo e(route('coinpayment.ajax.rate.usd', 0)); ?>')
            .then(function(json){
        ...
        getHistories(pageNum){
          ...
          this.isLoading = true;
          axios.get(`<?php echo e(route('coinpayment.ajax.transaction.histories')); ?>`,{
            params: {
              page: pageNum,
        ...
        manualCheck(e, params){
          ...
          axios.post('<?php echo e(route('coinpayment.ajax.transaction.manual.check')); ?>', params)
            .then(function(json){
