...
<div class="modal" id="login-modal" style="display: none">
    <header class="modal__header">
        <div class="span modal__title">Authorization</div>
    ...
    <form action="<?= route('frontend.auth.login.post') ?>" method="POST" data-type="ajax">
        ...
        <div class="modal__content">
            <div class="modal__input input">
                <label class="modal__label input__label">Username</label>
                <input placeholder="Username" type="text" name="username" class="modal__input-inner input__inner">
            </div>
            <div class="modal__input input">
                <label class="modal__label input__label">Password</label>
                ...
                <span class="modal__caption" data-toggle="modal" data-target=".popup_restorePassword">Forgot your password?</span>
				<?php endif; ?>
            </div>
...
<div class="popup popup_remindSuccess" style="display:none">
    ...
    <div class="popup__head">
        <div class="popup__title"> System notification</div>
    </div>
    <div class="popup__content">
        <div class="popup__title">Your password has been sent to your mail <br /> Good luck with your games!</div>
    </div>
    <div class="popup__footer">
        <div class="popup__button button button_color_brightblue js-close-popup">Close</div>
    </div>
</div>
<?php endif; ?>
<!-- POPUP RECOVER PASSWORD INFO WINDOW -->
...
<div class="modal" id="registration-confirm" style="display: none">
    <header class="modal__header">
        <div class="span modal__title">Registration</div>
        <span class="modal__icon icon icon_cancel js-close-popup"></span>
    </header>
    <form method="post" action="<?= route('frontend.register.post') ?>" data-type="ajax">
        ...
        <div class="modal__content">
            <div class="modal__input input">
                ...
                <input placeholder="E-mail" type="text" name="email" class="modal__input-inner input__inner">
            </div>
            <div class="modal__input input">
                <label class="modal__label input__label">Password</label>
                <input placeholder="Password" type="password" name="password" class="modal__input-inner input__inner">
...
<?php if(settings('reg_email_confirmation')): ?>	
	<div class="popup popup_emailVerification" style="display:none">
		...
		<div class="popup__content">
			<div class="popup__caption">The activation link has been sent to your e-mail, check it and follow the link to complete the verification</div>
		</div>
		<div class="popup__footer">
			<button class="popup__button button button_color_brightblue js-close-popup">Close</button>
		</div>
	</div>
	<?php if( app('request')->input('verify_email') ): ?>
	<span id="verifyEmailModal" style="display: none;" data-toggle="modal" data-target=".popup_emailVerification">Confirm email?</span>
	<?php endif; ?>
<?php endif; ?>
<!-- POPUP REGISTRATION INFO OK -->
...
<div class="popup popup_tabs" id="cabinet-modal" style="display: none">
    <div class="tab">
        <div class="tab__action">
            <a href="#cashier" target="_self" class="tab__item" data-toggle="tab">Cashbox</a>
            <a href="#profile" class="tab__item tab__item_active" data-toggle="tab">Profile</a>
            ...
            <div class="tab-cashier" id="cashier">
                ...
                <div class="tab-cashier__content">
                    <div class="tab tab_style_button">
                        <div class="tab__action">
                            <a href="#payment-tab" target="_self" data-toggle="tab" class="tab__item tab__item_active">Deposit</a>
                            <a href="#history-tab" target="_self" data-toggle="tab" class="tab__item">History</a>
                        </div>
                        <div class="tab__content">
                                            ...
                                            <div class="payment__row-inner">
                                                <label class="payment__item payitem" data-paysys="coinpayment">
                                                    ...
                                                    <div class="payitem__footer">
                                                        <p class="payitem__note payitem__note_small">Limits:</p>
                                            ...
                                            <div class="payment__tooltip_inner">
                                                <div class="pay-tooltip">
                                                    ...
                                                    <div class="pay-tooltip__pin" style="display: none">
                                                        ...
                                                        <button type="submit" class="pay-tooltip__button button button_color_orange">UPDATE</button>
                                                    </div>
                            ...
                            <div class="profile-info">
								...
								<div class="profile-info__bonus">
                                    <div class="rating rating_profile rating_profile_bonus">
                                        <div class="rating__summary">
                                            <span class="rating__title rating__title_large">BONUS:</span>
                                ...
                                <div class="profile-info__action">
                                    <button class="profile-info__button button button_color_orange" data-tab="#cashier" data-toggle="modal" data-target="#cabinet-modal">Cashbox</button>
                    ...
                    <div class="profile__main">
                        <form method="post" action="<?= route('frontend.profile.update.details') ?>" data-type="ajax" class="tab-profile__form">
                            ...
                            <div class="profile__action">
                                <a class="profile__button button button_color_brightblue" data-toggle="modal" data-target=".popup_changePassword">Change Password</a>
                                <button type="submit" class="profile__button profile__button_submit button button_color_orange">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="vip__action">
                    <div class="vip__table">
                        <form data-type="ajax" action="<?= route('frontend.profile.exchange') ?>" method="POST" id="exchange-form">
                            <input type="hidden" name="_token" value="<?= csrf_token() ?>">
                            <div class="vip__cell">
                                <span class="vip__subtitle">Amount of points</span>
                            ...
                            <div class="vip__cell">
                                <span class="vip__subtitle">You'll get</span>
                    ...
                    <button class="vip__button button button_color_orange" onclick="$('#exchange-form').submit()">Exchange for real money</button>
                </div>
...
<div class="popup popup_changePassword" style="display: none">
    <header class="modal__header">
        <div class="span modal__title">Change Password</div>
        <span class="modal__icon icon icon_cancel js-close-popup"></span>
    </header>
    <form action="<?= route('frontend.profile.update.password') ?>" method="POST" data-type="ajax" data-answer=".popup_passwordChanged">
        ...
        <div class="popup__content">
            <div class="popup__input input">
                <label class="popup__label popup__label_small input__label">Current password</label>
                <input type="password" name="old_password" required class="modal__input-inner input__inner" placeholder="Current password">
            </div>
            <div class="popup__input input">
                <label class="popup__label popup__label_small input__label">New password</label>
                <input type="password" name="password" required class="modal__input-inner input__inner" placeholder="New password">
            </div>
            <div class="popup__input input">
                <label class="popup__label popup__label_small input__label">Confirm password</label>
...
<div class="popup popup_passwordChanged" style="display:none">
    ...
    <div class="popup__content">
        <div class="popup__title">Your password has been changed <br /> Good luck with your games!</div>
    </div>
    <div class="popup__footer">
        <div class="popup__button button button_color_brightblue js-close-popup">Close</div>
    </div>
...
<div class="popup popup_setEmail" style="display: none">
    ...
    <form action="<?= route('frontend.social.callback.post', app('request')->all()) ?>" method="POST" >
		<input type="hidden" value="<?= csrf_token() ?>" name="_token">
        <div class="popup__head">
            <div class="popup__title">Specify Email</div>
        </div>
        <div class="popup__content">
            <div class="popup__subtitle">Your e-mail</div>
            <div class="popup__input input">
...
<span id="showEmailModal" style="display: none;" data-toggle="modal" data-target=".popup_setEmail">Specify email?</span>
<?php endif; ?>
...
<div class="popup popup_returnsSuccess" style="display:none">
    ...
    <div class="popup__head">
        <div class="popup__title">Notification</div>
    </div>
    <div class="popup__content">
        <div class="popup__title">Refund <span id="returnsValue"></span> amount added to your balance!<br><br><br></div>
    </div>
    <div class="popup__footer">
        <div class="popup__button button button_color_brightblue js-close-popup">Close</div>
    </div>
...
<div class="scroller">
    ...
    <span class="scroller__note">To the top</span>
</div>