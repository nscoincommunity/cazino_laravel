<div class="header__toppanel">
    <div class="toppanel">
        <div class="toppanel__title">
            <span class="toppanel__name">Hello!</span>
        </div>
...
<div class="mobile-nav mobile-nav_dropdown js-mobilenav-dropdown">
    <ul class="mobile-nav__list">
        ...
        <li class="mobile-nav__item">
            ...
            <a class="mobile-nav__link " href="#">Lottery</a>
        </li>
        <li class="mobile-nav__item">
            <span class="mobile-nav__icon ">
...
<div class="header__panel">
    ...
    <div class="logo">
        ...
        <div class="head-panel__cell head-panel__cell_fluid">
            <div class="head-panel__signup">
                <div class="signup">
                    <a class="signup__button button button_font_cond button_color_orange" data-toggle="modal" data-target="#registration-confirm">Registration</a>
    ...
    <div class="logo">
		...
		<?php if(settings('reg_enabled')): ?>
        <a class="mobile-panel__button button button_color_orange" data-toggle="modal" data-target="#registration-confirm">Registration</a>
		<?php endif; ?>
        <a class="mobile-panel__button mobile-panel__button_blue button" data-toggle="modal" href="#login-modal">Login</a>
    </div>
</div>