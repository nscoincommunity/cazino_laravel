        ...
        <div class="card-body">
            ...
            <div class="p-4">
                ...
                <?php if(settings('forgot_password')): ?>
                    <a href="<?= route('backend.password.remind') ?>" class="forgot"><?php echo app('translator')->getFromJson('app.i_forgot_my_password'); ?></a>
                <?php endif; ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <?php echo JsValidator::formRequest('VanguardDK\Http\Requests\Auth\LoginRequest', '#login-form'); ?>
