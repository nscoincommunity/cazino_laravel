    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <?php if(settings('registration.captcha.enabled')): ?>
                <?php echo Form::open(['route' => 'backend.settings.registration.captcha.disable', 'id' => 'captcha-settings-form']); ?>
            ...
            <?php else: ?>
                <?php echo Form::open(['route' => 'backend.settings.registration.captcha.enable', 'id' => 'captcha-settings-form']); ?>
