                                ...
                                <div id="payout-tab" class="history">
                                    <div class="payment__gallery">
                                        ...
                                        <?php $__currentLoopData = $fiveManyList->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <form method="POST" action="<?php echo e(route('frontend.payment.addtask.post')); ?>"
                                                  class="payment-form" data-type="ajax">
                                                            ...
                                                            <label class="payment__item payitem">
                                                                ...
                                                                <div class="payitem__footer">
                                                                    ...
                                                                    <p class="payitem__note"><?php echo e($fiveManyItem->min_amount); ?>
                                                                        ...
                                                                        - <?php echo e($fiveManyItem->max_amount); ?> руб</p>
                                                                </div>
                                                            </label>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                ...
                                                <div class="rating__info">
                                                    ...
                                                    <div class="rating__tooltip tooltip tooltip_right">
                                                        <div class="tooltip__content">Вам необходимо внести депозиты на
                                                            сумму <?php echo e(Auth::user()->left_next_level()); ?> для следующего
                                                            уровня
                                                        </div>
                        ...
                        <div class="levels-table">
                            <div class="levels-table__table">
                                <?php $__currentLoopData = \VanguardDK\Point::orderBy('rating', 'ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="levels-table__item <?php if($point->rating == Auth::user()->rating): ?> levels-table__item_active <?php endif; ?>"
                                         data-toggle="tab" data-target="#vip_level_description_<?php echo e($point->rating); ?>">
                            ...
                            <div class="tab__content">
                                <?php $__currentLoopData = \VanguardDK\Point::orderBy('rating', 'ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="levels-table__info <?php if($point->rating == Auth::user()->rating): ?> active <?php endif; ?>"
                                         id="vip_level_description_<?php echo e($point->rating); ?>">
