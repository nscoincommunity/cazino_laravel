<?php $__env->startSection('page-title', trans('app.pages')); ?>
<?php $__env->startSection('page-heading', trans('app.pages')); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item active">
        <?php echo app('translator')->getFromJson('app.pages'); ?>
    </li>
    ...
    <div class="card-body">
		...
		<form action="" method="GET" id="pages-form" class="pb-2 mb-3 border-bottom-light">
            <div class="row my-3 flex-md-row flex-column-reverse">
                ...
                <div class="col-md-6">
					<a href="<?php echo e(route('backend.pages.create')); ?>" class="btn btn-primary btn-rounded float-right">
                ...
                <tbody>
                    <?php if(count($pages)): ?>
                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('backend.pages.partials.row', ['base' => true], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
