<nav class="navbar fixed-top align-items-start navbar-expand-lg pl-0 pr-0 py-0" >
    ...
    <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand mr-0" href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(url('assets/img/logo.png')); ?>" alt="<?php echo e(settings('app_name')); ?>">
        </a>
    </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right position-absolute" aria-labelledby="navbarDropdown">
                    ...
                    <?php if(config('session.driver') == 'database'): ?>
                        <a href="<?php echo e(route('backend.profile.sessions')); ?>" class="dropdown-item">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('backend.auth.logout')); ?>">
