...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item">
        <?php echo e($return->min_pay . ' ' . $return->max_pay); ?>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    <?php echo $__env->make('backend.returns.partials.base', ['edit' => true], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="submit" class="btn btn-primary">
                <?php echo app('translator')->getFromJson('app.edit_return'); ?>
            </button>
        </div>
    </div>
<?php echo Form::close(); ?>
