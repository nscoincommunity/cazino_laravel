...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/AlchemistsSecretGT/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/AlchemistsSecretGT/source/LOADER/progress'+i+'.png');
