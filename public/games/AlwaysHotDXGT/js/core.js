...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/AlwaysHotDXGT/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/AlwaysHotDXGT/source/LOADER/progress'+i+'.png');
