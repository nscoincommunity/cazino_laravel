...
Preloader.outerCircle=PIXI.Sprite.fromImage('/games/AlwaysHotCubesGT/source/LOADER/loading.png');
...
Preloader.innerCircleArr[i]=PIXI.Sprite.fromImage('/games/AlwaysHotCubesGT/source/LOADER/progress'+i+'.png');
