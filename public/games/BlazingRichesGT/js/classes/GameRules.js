...
if(cObj.scaleX!=undefined && cObj.scaleY!=undefined){
objArr[objId].scale.x=cObj.scaleX;
objArr[objId].scale.y=cObj.scaleY;  
}
...
TextFormat(objArr['payText'+payTable[i]+'_'+j+'_def'],7);
...
TextFormat(objArr['payText'+payTable[i]+'_'+j+'_wild'],7);
...
objArr['rulesPage1Text2'].text=NumFormat(slotSettings.slotJackpot);
};


this.ViewPage=function(target){
