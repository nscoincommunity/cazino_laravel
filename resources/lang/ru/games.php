...
'QueenOfNile' => [
'counterCredit' => "Баланс:",
'counterLines' => "ЛИНИИ",
'counterBetLine' => "СТАВКА НА ЛИНИЮ",
'counterLastWin' => "ВЫИГРАТЬ",
'counterAuto' => "",
'counterBet' => "ПОЛНАЯ СТАВКА",
'counterCurText' => "",
'counterInfo1GameOver' => "Пожалуйста, сделайте ставку",
'counterInfo1Spin' => "Удачи!",
'counterBonusFreeStart' => "ПОЗДРАВЛЯЕМ!",
'counterBonusFreeStart2' => "Вы выиграли 15 бесплатных спинов \ n Все призы x3",
'counterBonusFreeMore' => "ПОЗДРАВЛЯЕМ ",
'counterBonusFreeMore2' => "15 БОЛЬШЕ БЕСПЛАТНЫХ ИГР ",
'counterBonusFreeEnd' => "ПОЗДРАВЛЯЕМ!",
'counterBonusFreeEnd2' => "Ты победил ",
'counterBonusFreeEndPlayed' => " БЕСПЛАТНЫЕ ИГРЫ СЫГРАНЫ",
'counterBonusHeaderWin' => "WIN\n",
'counterInfo2StartBonus' => "Пожалуйста, нажмите Старт",
'counterInfo2Won' => "Линия ",
'counterInfo2Won2' => "победы ",
'counterInfo2Free' => " Оставшиеся бесплатные спины",
'counterAuto' => "АВТО",
'gambleRedLabel' => "Красный",
'gambleBlackLabel' => "Чёрный",
