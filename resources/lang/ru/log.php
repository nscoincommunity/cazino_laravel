...
return [
    'new_permission' => 'Создано новое разрешение под названием: :name.',
    'updated_permission' => 'Обновлено разрешение с именем :name.',
    'deleted_permission' => 'Удалено разрешение по имени :name.',

    'new_role' => 'Создана новая роль под названием :name.',
