...
@section('breadcrumbs')
    @if (isset($user) && isset($adminView))
        <li class="breadcrumb-item">
            <a href="{{ route('frontend.activity.index') }}">@lang('app.activity_log')</a>
        </li>
                    ...
                    <div class="input-group custom-search-form">
                        ...
                        <span class="input-group-append">
                            @if (Input::has('search') && Input::get('search') != '')
                                <a href="{{ isset($adminView) ? route('frontend.activity.index') : route('profile.activity') }}"
        ...
        <div class="table-responsive">
            <table class="table table-borderless table-striped">
                <thead>
                    ...
                    @endif
                    <th class="min-width-100">@lang('app.ip_address')</th>
                    <th class="min-width-100">@lang('app.message')</th>
                    <th class="min-width-100">@lang('app.log_time')</th>
                    <th class="text-center min-width-100">@lang('app.more_info')</th>
                </thead>
                <tbody>
                        ...
                        <tr>
                            @if (isset($adminView))
                                <td>
                                    ...
                                    @else
                                        <a href="{{ route('frontend.activity.user', $activity->user_id) }}"
