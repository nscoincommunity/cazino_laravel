        ...
        <div class="modal__content">
            ...
            <div class="modal__input input">
                ...
                @if (settings('forgot_password'))
                    <span class="modal__caption" data-toggle="modal"
                          data-target=".popup_restorePassword">Забыли пароль?</span>
                @endif
            </div>
...
@if (settings('forgot_password'))
    <div class="popup popup_restorePassword" style="display: none">
        ...
        <form action="<?= route('frontend.password.remind.post') ?>" method="POST" data-type="ajax"
              data-answer=".popup_remindSuccess">
    ...
    <div class="modal" id="registration-confirm" style="display: none">
        ...
        <form method="post" action="<?= route('frontend.register.post') ?>" data-type="ajax">
            ...
            <div class="modal__content">
                ...
                <div class="modal__input input">
                    <label class="modal__label input__label">Пароль</label>
                    <input placeholder="Придумайте пароль" type="password" name="password"
...
@if (settings('reg_email_confirmation'))
    <div class="popup popup_emailVerification" style="display:none">
        ...
        <div class="popup__content">
            <div class="popup__caption">Ссылка для активации была отправлена на ваш адрес электронной почты, проверьте
                ее и перейдите по ссылке для завершения проверки
            </div>
        </div>
        <div class="popup__footer">
    ...
    @if ( app('request')->input('verify_email') )
                ...
                <div class="tab-cashier" id="cashier">
                    ...
                    <div class="tab-cashier__content">
                        <div class="tab tab_style_button">
                            <div class="tab__action">
                                <a href="#payment-tab" target="_self" data-toggle="tab"
                                   class="tab__item tab__item_active">Депозит</a>
                            ...
                            <div class="tab__content">
                                <div id="payment-tab" class="active payment">
                                    <div class="payment__gallery">
                                        <form method="POST" action="<?= route('frontend.profile.balance.post') ?>"
                                              class="payment-form" data-type="ajax">
                                            <input type="hidden" name="_token" value="<?= csrf_token() ?>">
                                            ...
                                            <div class="payment__row">
                                                <div class="payment__row-inner">
                                                    <label class="payment__item payitem" data-paysys="coinpayment">
                                                        <input type="radio" name="system" value="coinpayment"
                                                               style="display:none">
                                                        ...
                                                        <div class="payitem__footer">
                                                            ...
                                                            <p class="payitem__note">100 - 10000 </p>
                                                        </div>
                                                    </label>
                                                    ...
                                                    <div class="pay-tooltip">
                                                        ...
                                                        <div class="pay-tooltip__summ">
                                                            ...
                                                            <label><input id="p_0_500" type="radio" name="money"
                                                                          value="100,00"> 100</label>
                                                            <label><input id="p_0_1000" type="radio" name="money"
                                                                          value="200,00"> 200</label>
                                                            <label><input id="p_0_5000" type="radio" name="money"
                                                                          value="300,00"> 300</label>
                                                            <label><input id="p_0_500" type="radio" name="money"
                                                                          value="500,00"> 500</label>
                                                            <input id="l_0_num" type="radio" name="money" value="100"
                                                                   checked class="l_num">
                                ...
                                <div id="payout-tab" class="history">
                                    <div class="payment__gallery">
                                        ...
                                        @foreach($fiveManyList->chunk(3) as $chunk)
                                            <form method="POST" action="{{route('frontend.payment.addtask.post')}}"
                                                  class="payment-form" data-type="ajax">
                                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                    ...
                                                    <div class="payment__tooltip_inner">
                                                        <div class="pay-tooltip pay-tooltip_withphone">
                                                            ...
                                                            <div class="pay-tooltip__number pay-tooltip__number_withplus">
                                                                <span class="pay-tooltip__caption">Номер кошелька:</span>
                                                                <span class="pay-tooltip__input">
                                                        <input type="tel" name="account" placeholder="70000000000"
                                                               required="required"
                                                               class="pay-tooltip__number_inner input__inner js-input__inner"
                                                               maxlength="14">
                                                        </span>
                                                            </div>
                                                            <div class="pay-tooltip__input input">Сумма к выводу:
                                                                <input type="text" required="" placeholder="Сума"
                                                                       name="amount"
                                                            ...
                                                            <button type="submit"
                                                                    class="pay-tooltip__button pay-tooltip__button_withdraw button button_color_orange">
                                                                Вывод
                                                            </button>
                                                        </div>
                                                    </div>
                ...
                <div class="profile active" id="profile">
                    <div class="profile__table">
                            ...
                            <div class="profile__info">
                                <div class="profile-info">
                                            ...
                                            <div class="rating__bar">
                                                ...
                                                <div class="rating__info">
                                                    ...
                                                    <div class="rating__tooltip tooltip tooltip_right">
                                                        <div class="tooltip__content">Вам необходимо внести депозиты на
                                                            сумму {{ Auth::user()->left_next_level() }} для следующего
                                                            уровня
                                                        </div>
                                    ...
                                    <div class="profile-info__action">
                                        <button class="profile-info__button button button_color_orange"
                                                data-tab="#cashier" data-toggle="modal" data-target="#cabinet-modal">
                                            Касса
                                        </button>
                        ...
                        <div class="profile__main">
                            <form method="post" action="<?= route('frontend.profile.update.details') ?>"
                                ...
                                <div class="profile-contacts">
                                    <h3 class="profile-contacts__title title title_align_center">Контактная
                                        информация</h3>
                ...
                <div class="vip active" id="vip">
                    ...
                    <div class="vip__action">
                        <div class="vip__table">
                            <form data-type="ajax" action="<?= route('frontend.profile.exchange') ?>" method="POST"
                                  id="exchange-form">
                                <input type="hidden" name="_token" value="<?= csrf_token() ?>">
                                <div class="vip__cell">
                        ...
                        <button class="vip__button button button_color_orange" onclick="$('#exchange-form').submit()">
                            Обмен на реальные деньги
                        </button>
                    </div>
                    <div class="vip__levels-table">
                        <div class="levels-table">
                            <div class="levels-table__table">
                                @foreach( \VanguardDK\Point::orderBy('rating', 'ASC')->get() AS $point )
                                    <div class="levels-table__item @if($point->rating == Auth::user()->rating) levels-table__item_active @endif"
                                         data-toggle="tab" data-target="#vip_level_description_{{ $point->rating }}">
                            ...
                            <div class="tab__content">
                                @foreach( \VanguardDK\Point::orderBy('rating', 'ASC')->get() AS $point )
                                    <div class="levels-table__info @if($point->rating == Auth::user()->rating) active @endif"
                                         id="vip_level_description_{{ $point->rating }}">
...
<div class="popup popup_changePassword" style="display: none">
    ...
    <form action="<?= route('frontend.profile.update.password') ?>" method="POST" data-type="ajax"
          data-answer=".popup_passwordChanged">
        <input type="hidden" name="_token" value="<?= csrf_token() ?>">
        <div class="popup__content">
            <div class="popup__input input">
...
@if ( app('request')->input('provider') )
    ...
    <span id="showEmailModal" style="display: none;" data-toggle="modal"
          data-target=".popup_setEmail">Укажите email?</span>
@endif
...
<div class="popup popup_returnsSuccess" style="display:none">
    ...
    <div class="popup__content">
        <div class="popup__title">Возврат <span id="returnsValue"></span> сумма добавлена на ваш баланс!<br><br><br>
        </div>
    </div>
    <div class="popup__footer">
        <div class="popup__button button button_color_brightblue js-close-popup">Закрыть</div>
