...
<!--[if (gt IE 9)|!(IE)]><!-->
<html class="ie9up" lang="{{app()->getLocale()}}"><!--<![endif]-->
<head>
    <title>@yield('page-title') - {{settings('app_name')}}</title>
    <!-- META TAGS -->
    <link rel="shortcut icon" type="image/png" href="{{url('assets/_new-style/images/favicon/spc.png')}}">
    <link rel="icon" type="image/png" href="{{url('assets/_new-style/images/favicon/spc.png')}}">
    <link rel="apple-touch-icon" href="{{url('assets/_new-style/images/favicon/spc-iphone.png')}}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{url('assets/_new-style/images/favicon/spc-ipad.png')}}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{url('assets/_new-style/images/favicon/spc-ipad2.png')}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{url('assets/_new-style/images/favicon/spc-ipad3.png')}}">
    ...
    <link href="https://fonts.googleapis.com/css?family=PT+Sans:400,700&amp;subset=cyrillic,cyrillic-ext,latin-ext"
          rel="stylesheet">
    <script src="{{url('assets/_new-style/js/jquery.1.8.2.min.js')}}"></script>
    <script type="text/javascript" src="{{ url('assets/_new-style/js/angular.min.js')}}"></script>
    <!--[if lt IE 9]>
    <script src="{{url('assets/_new-style/js/html5shiv.min.js')}}"></script>
    <script src="{{url('assets/_new-style/js/respond.min.js')}}"></script><![endif]-->

    <!-- DEFAULT CSS -->
    <link href="{{url('assets/_new-style/css/reset.css')}}" rel="stylesheet" type="text/css" class="styles"/>
    <!-- Flags -->
    <link rel="stylesheet" href="{{url('assets/plugins/flag-icon-css/css/flag-icon.min.css')}}">
    <!-- Perfect scrollbar css -->
    <link rel="stylesheet" type="text/css" href="{{url('assets/_new-style/css/perfect-scrollbar.css')}}">
    <!-- zebra datepicker -->
    <link rel="stylesheet" type="text/css" href="{{url('assets/_new-style/css/zebra_datepicker.css')}}">
    <!-- START OF ALL CUSTOM CSS + FONTS -->
    <link href="{{url('assets/_new-style/css/style.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{url('assets/_new-style/css/regional.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="{{url('assets/_new-style/css/oct7vfe.css')}}">

    <!-- DEFAULT JS SCRIPTS -->
    <!--[if lt IE 9]>
    <script src="{{url('assets/_new-style/js/html5-shiv.js')}}" type="text/javascript"></script>
    <![endif]-->
</head>
...
<style>
    @-webkit-keyframes lights {
        0% {
            background-image: url("{{url('assets/_new-style/images/cobranded_board.png')}}");
        }

        100% {
            background-image: url("{{url('assets/_new-style/images/cobranded_board_1.png')}}");
        }
    }

    @-webkit-keyframes lightsMobile {
        0% {
            background-image: url("{{url('assets/_new-style/images/cobranded_board_mobile.png')}}");
        }

        100% {
            background-image: url("{{url('assets/_new-style/images/cobranded_board_mobile_1.png')}}");
        }
    }
    ...
    .games__hero__wrapper {
        background-image: url("{{url('assets/_new-style/images/spin-mobile.jpg')}}");
    ...
    @media screen and (min-width: 1020px) {
        ...
        .games__hero__wrapper {
            background-image: url("{{url('assets/_new-style/images/spin-desktop.jpg')}}");
            padding-bottom: 31vw;
        }
...
<div class="ls__fixed__btn">
    <a class="button-ls lc"><img src="{{ url('assets/_new-style/images/livesupport.png')}}"/></a>
</div>
            ...
            <div>
                ...
                <div id="navbar-mobile">
                    <a href="{{url('/')}}" class="close">
                        <img src="{{ url('assets/_new-style/images/icon_close.png')}}"/>
                    </a>
                    <div class="navbar-mobile-logo sign__up">
                        <img src="{{ url('assets/_new-style/images/logo.png')}}" alt="logo" class="logo"/>
                    </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link languages" href="index.html#">Languages
                                <span class="right-chevron">
                                    <img src="{{url('assets/_new-style/images/right_chevron.png')}}"/>
                                </span>
                            </a>
                        </li>
{{--                        <li class="nav-item sign__up">--}}
{{--                            <a class="nav-link" href="index.html#">Banking</a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="nav-link lc" href="index.html#">24/7 support</a>--}}
{{--                        </li>--}}
                    </ul>
                    ...
                    <div id="mobile-submenu">
                        ...
                        <div class="navbar-mobile-logo sign__up">
                            <a>
                                <img src="{{ url('assets/_new-style/images/logo.png')}}"
                                     alt="logo" class="logo"/>
                            </a>
                        </div>
                        <a href="index.html#"><span class="back">
                        <img src="{{ url('assets/_new-style/images/left_chevron.png')}}"/>BACK</span></a>
                    </div>
                </div>
                ...
                <nav class="navbar navbar-toggleable-md navbar-inverse" id="navbar-main">
                    <div class="container">
                        ...
                        <a href="{{url('/')}}" class="navbar-brand sign__up">
                            <img src="{{url('assets/_new-style/images/logo.png')}}" alt="logo"/>
                        </a>
                        @if (Auth::check())
                            <ul class="games__button__mobile">
                                ...
                                <li class="last">
                                    <a href="{{ route('frontend.auth.logout') }}" class="games__button  button-logout">
                                        @lang('app.logout')
                                    </a>
                                </li>
                            </ul>
                                        ...
                                        <div id="language-select" class="btn-info button-lang btn-collapsible lc">
                                            ...
                                            <span>
                                                @foreach(['ru', 'en', 'de'] as $langCode)
                                                    ...
                                                    <i data-lang-code="{{$langCode}}" class="flag-icon flag-icon-{{$langCode}}"></i>
                                                    @endif
                                                @endforeach
                                            </span>
                                        </div>
    ...
    <div class="games__hero__offer__wrapper ">
        <div class="cobranded_board">
            <img src="{{ url('assets/_new-style/images/casinoreviewslogo.png')}}"/>
        </div>
                ...
                <div class="">
                    <div class="games__offer__text ">
                        ...
                        <a class="games__button button-hero sign__up" ng-click="openModal($event, '#registration-confirm')">
                            SIGN UP
                            <img src="{{ url('assets/_new-style/images/cta-arrow.png')}}" alt="cta arrow" class="cta-arrow"/>
                        </a>
                        @endif
                        ...
                        <style>
                            ...
                            .close-icon {
                                background-image: url("{{url('assets/_new-style/images/close-button.png')}}");
...
<section class="games__wrapper">
    @include('frontend._new-style.part.nav')
    ...
    <div class="footer">
        <div class="col-1">
            <div class="games__footer__icons">
                <img src="{{url('assets/_new-style/images/footer_icons_0.png')}}"/>
                <br/>
                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="{{url('assets/_new-style/images/footer_icons_1.png')}}"/>
                </a>
                <a target="_blank"
                   href="#"
                   style="display:inline-block;">
                    <img src="{{url('assets/_new-style/images/footer_icons_2.png')}}"/>
                </a>


                <a target="_blank" href="#"
                   style="display:inline-block;">
                    <img src="{{url('assets/_new-style/images/footer_icons_4.png')}}"/>
                </a>


                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="{{url('assets/_new-style/images/en18logo.png')}}"/>
                </a>


                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="{{url('assets/_new-style/images/gambleaware.png')}}"/>
                </a>
                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="{{url('assets/_new-style/images/microgaming.png')}}"/>
                </a>
                <img src="{{url('assets/_new-style/images/footer_icons_5.png')}}"/>
                <img src="{{url('assets/_new-style/images/footer_icons_6.png')}}"/>
                <img src="{{url('assets/_new-style/images/footer_icons_7.png')}}"/>
                <img src="{{url('assets/_new-style/images/footer_icons_8.png')}}"/>
...
@include('frontend._new-style.part.modals')
@include('frontend._new-style.part.lock-screen')
<!-- Preconnect CSS -->
<style>
    body.no-scroll {
        overflow: hidden;
...
<script type="text/javascript" src="{{url('assets/_new-style/js/jquery-1.7.1.min.js')}}"></script>
<script type="text/javascript" src="{{url('assets/_new-style/js/jquery.corsproxy.1.0.0.js')}}"></script>
<script type="text/javascript" src="{{url('assets/_new-style/js/perfect-scrollbar.jquery.js')}}"></script>
<script type="text/javascript" src="{{url('assets/_new-style/js/zebra_datepicker.min.js')}}"></script>
...
<script type="text/javascript" src="{{url('assets/_new-style/js/app.js')}}"></script>
<script type="text/javascript" src="{{url('assets/_new-style/js/angular-lazy-img.min.js')}}"></script>
<script type="text/javascript" src="{{url('assets/_new-style/js/game-controller.js')}}"></script>
<script>
