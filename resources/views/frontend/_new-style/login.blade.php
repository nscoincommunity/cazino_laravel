...
<body ng-app="app" ng-controller="loginCtrl">
    <div id="login" class="hide" ng-class="{show: activeForm==='login'}">
        ...
        <form ng-submit="sendForm($event)" action="{{route('frontend.auth.login.post')}}" method="post">
            <div class="form-group">
                <input required type="text" name="username" placeholder="@lang('app.username')"/>
            </div>
            <div class="form-group">
                <input required type="password" name="password" placeholder="@lang('app.password')"/>
            </div>
            <div class="other-invalid-feedback"></div>
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block btn-large">@lang('app.login')</button>
            </div>
            <p>
                <a href="#" ng-click="switchActiveForm($event, 'register')">@lang('app.register')</a> |
                <a href="#" ng-click="switchActiveForm($event, 'forgot-password')">@lang('app.restore_password')</a>
            </p>
        </form>
    </div>
    ...
    <div id="register" class="hide" ng-class="{show: activeForm==='register'}">
        ...
        <form ng-submit="sendForm($event)" method="post" action="{{route('frontend.register.post')}}">
            <div class="form-group">
                <input required placeholder="@lang('app.email')" type="text" name="email">
            </div>
            <div class="form-group">
                <input required placeholder="@lang('app.password')" type="password" name="password">
            </div>
            @if (settings('tos'))
                <div class="form-group">
                    <label for="terms">
            ...
            <div class="other-invalid-feedback"></div>
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block btn-large">@lang('app.register')</button>
            </div>
            <p>
                <a href="#" ng-click="switchActiveForm($event, 'login')">@lang('app.login')</a>
            </p>
        </form>
    </div>

    <div id="forgot-password" class="hide" ng-class="{show: activeForm==='forgot-password'}">
        <h1>@lang('app.restore_password')</h1>
        <form ng-submit="sendForm($event)" action="{{route('frontend.password.remind.post')}}" method="post">
            <div class="form-group">
                <input type="text" name="email" required placeholder="@lang('app.email')">
            </div>
            <div class="other-invalid-feedback"></div>
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block btn-large">@lang('app.request_new_password')</button>
            </div>
            <p>
                <a href="#" ng-click="switchActiveForm($event, 'login')">@lang('app.login')</a>
            </p>
...
<script type="text/javascript" src="{{url('assets/_new-style/js/login-controller.js')}}"></script>
</body>
</html>
