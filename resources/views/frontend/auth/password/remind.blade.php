...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p">
    ...
    <div class="card mt-5">
        <div class="card-body">
            ...
            <div class="p-4">
                <form role="form" action="<?= route('frontend.password.remind') ?>" method="POST" id="remind-password-form" autocomplete="off">
                    {{ csrf_field() }}
        ...
        <div class="text-center text-muted">
            @if (settings('reg_enabled'))
                ...
                <a class="font-weight-bold" href="<?= url("frontend.login") ?>">@lang('app.login')</a>
            @endif
        </div>
</div>
...
@section('scripts')
    {!! JsValidator::formRequest('VanguardDK\Http\Requests\Auth\PasswordRemindRequest', '#remind-password-form') !!}
@stop