...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p">
    ...
    <div class="card mt-5">
        <div class="card-body">
            ...
            <form role="form" action="{{ route('frontend.password.reset.post') }}" method="POST" id="reset-password-form" autocomplete="off" class="p-4">
...
@section('scripts')
    {!! JsValidator::formRequest('VanguardDK\Http\Requests\Auth\PasswordResetRequest', '#reset-password-form') !!}
@stop