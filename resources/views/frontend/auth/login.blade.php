    ...
    <div class="card mt-5">
        <div class="card-body">
            ...
            <div class="p-4">
                ...
                <form role="form" action="<?= route('frontend.auth.login.post') ?>" method="POST" id="login-form" autocomplete="off" class="mt-3">
                ...
                @if (settings('forgot_password'))
                    <a href="<?= route('frontend.password.remind') ?>" class="forgot">@lang('app.i_forgot_my_password')</a>
                @endif
