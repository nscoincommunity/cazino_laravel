        ...
        <div class="card mt-5">
            <div class="card-body">
                ...
                <div class="p-4">
                    ...
                    <form role="form" action="<?= url('frontend.register') ?>" method="post" id="registration-form" autocomplete="off" class="mt-3">
...
@section('scripts')
    {!! JsValidator::formRequest('VanguardDK\Http\Requests\Auth\RegisterRequest', '#registration-form') !!}
@stop