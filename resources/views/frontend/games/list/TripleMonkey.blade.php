...
setTimeout(function(){document.getElementById('quit').style['display']='';},300);
	...
	<div id="quit" onclick="document.location.href='../../../';window.parent.postMessage('CloseGame','*');" style="display:none;position:fixed;right:14px;top:14px;cursor:pointer;"> <img style="width:41px;height:42px;" src="addons/quit2.png"></div>
