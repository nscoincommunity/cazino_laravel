...
<div class="row">
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('backend.profile') }}" class="text-center no-decoration">
                    <div class="icon my-3">
    ...
    @if (config('session.driver') == 'database')
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('backend.profile.sessions') }}" class="text-center  no-decoration">
                        <div class="icon my-3">
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('backend.profile.activity') }}" class="text-center no-decoration">
                    <div class="icon my-3">
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('backend.auth.logout') }}" class="text-center no-decoration">
                    <div class="icon my-3">
