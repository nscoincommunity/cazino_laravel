    ...
    <div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p">
        ...
        <div class="card mt-5">
            <div class="card-body">
                ...
                <div class="p-4">
                    ...
                    <form role="form" action="<?= url('backend.register') ?>" method="post" id="registration-form" autocomplete="off" class="mt-3">
        ...
        <div class="text-center text-muted">
            @if (settings('reg_enabled'))
                ...
                <a class="font-weight-bold" href="<?= url("backend.login") ?>">@lang('app.login')</a>
            @endif
        </div>
